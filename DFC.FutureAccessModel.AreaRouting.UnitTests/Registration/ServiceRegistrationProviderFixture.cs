...
namespace DFC.FutureAccessModel.AreaRouting.Registration
{
        ...
        MoqTestingFixture
    {
        ...
        public void AddScopedMeetsExpectation()
        {
            ...
            var registration = new ExternalRegistrationAttribute(typeof(IManageAreaRoutingDetails), typeof(AreaRoutingDetailManagementFunctionAdapter), TypeOfRegistrationScope.Scoped);
