...
namespace DFC.FutureAccessModel.AreaRouting.Factories
{
        ...
        MoqTestingFixture
    {
        ...
        public async Task EnterMethodLoggerMeetsVerification()
        {
            ...
            SetupLogger(sut.Log, LogLevel.Information, "entering method: 'EnterMethodLoggerMeetsVerification'");
        ...
        public async Task ExitMethodLoggerMeetsVerification()
        {
            ...
            SetupLogger(sut.Log, LogLevel.Information, "exiting method: 'ExitMethodLoggerMeetsVerification'");
            ...
            VerifyLogger(sut.Log, LogLevel.Information, "exiting method: 'ExitMethodLoggerMeetsVerification'");
        }
        ...
        public async Task RecordingAMessageLogHelperMeetsVerification()
        {
            ...
            SetupLogger(sut.Log, LogLevel.Information, message);
        ...
        public async Task RecordingAnExceptionLoggerMeetsVerification()
        {
            ...
            // assert
            GetMock(sut.Log).VerifyAll();
            VerifyLogger(sut.Log, LogLevel.Error, string.Empty, exception);
        }
